...
from .parampref import ParamPreferences

class PreferencesDialog(QDialog):
    
    pages = [PlotPreferences, ParamPreferences]
    ...
    def __init__(self, parent=None):
        ...
        # self.paramPref = ParamPreferences(parent)
        # self.pagesWidget.addWidget(self.plotPref)
        # self.pagesWidget.addWidget(self.paramPref)
        
        # self.contentsWidget.addItem("Plot")
        # self.contentsWidget.addItem("Params")
