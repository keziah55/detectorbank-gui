...
if __name__ == '__main__':
    ...
    local_share = Path.home().joinpath(".local", "share")
    app_name = "detectorbank-gui"
    splash_path = None
    possible_paths = [
        Path("images", "splash.png"),
        local_share.joinpath(app_name, "splash.png")
    ]
    ...
    p = local_share.joinpath("applications", f"{app_name}.desktop")
    if p.exists():
